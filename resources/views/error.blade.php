    ...
    <div class="flex justify-center mb-6">
        <div class="bg-red-600 p-4 rounded-full">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-white" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm-.75-4.25a.75.75 0 111.5 0 .75.75 0 01-1.5 0zM9.25 6a.75.75 0 011.5 0v5a.75.75 0 01-1.5 0V6z" clip-rule="evenodd" />
            </svg>
        </div>
    </div>
    <h2 class="text-2xl font-semibold text-red-800 mb-2">System Failure</h2>
