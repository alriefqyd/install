...
<head>
    <meta charset="UTF-8">
    <title>Finalize Successful</title>
...
<div class="bg-white rounded-2xl shadow-lg p-8 max-w-lg w-full text-center">
    ...
    <h2 class="text-2xl font-semibold text-teal-800 mb-2">Finalize Successful</h2>
    <p class="text-gray-700 mb-6">Your instrument index detail has been successfully finalize. We will review it and respond to you as soon as possible.
